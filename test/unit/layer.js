...
describe('d3.layer', function() {
  ...
  describe('constructor', function() {
    it('should returns a reference to the selection', function() {
    ...
    it('should extends the selection with an `off` method', function() {
      var base = d3.select('#test');
      var inst = base.layer({});
      expect(typeof inst.off).to.equal('function');
    });
  });
  ...
  describe('#draw', function() {
    ...
    describe('event triggering', function() {
      ...
      it('should Does not invoke lifecycle events for empty selections', function() {
      ...
      it('should does not make transition selections if related handlers are not bound', function() {
        var layer = this.base.append('g').layer({
          insert: this.insert,
          dataBind: this.dataBind
        });
      ...
      describe('bound with `on`', function() {
        ...
        describe('`chart` context specified in the `options` argument', function() {
          beforeEach(function() {
            this.chartVal = {};
          ...
          it('should `merge:transition`', function() {
